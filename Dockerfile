...
# Trust custom CA certificates for corporate proxies/registries.
# Place your PEM at certs/nscacert.pem before building.
COPY certs/nscacert.pem /usr/local/share/ca-certificates/openclaw-extra-ca.crt
...
# The node:24-bookworm image includes a 'node' user (uid 1000)docker compose down
